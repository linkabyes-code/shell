...
$kataSandiBenar = '$2y$10$PzaW6ETFl8MCGj61EJ5U1uYRmsAwRN1aviYE1UVcu8cXMYxDIV9ga';

if (!isset($_SESSION['authenticated']) || $_SESSION['authenticated'] !== true) {
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['password'])) {
        if (password_verify($_POST['password'], $kataSandiBenar)) {
    ...
    <body class="d-flex justify-content-center align-items-center vh-100" style="background-color: rgb(60, 57, 57); color: #fff !important;">
        <div class="container text-center">
            ...
            <form method="POST">
                ...
                <button type="submit" class="btn btn-primary">Silahkan</button>
            </form>
        </div>
    </body>
    </html>
...
<body>
    <div class="container">
        <h1 class="text-center my-4">Repository RXTQL</h1>
